          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
            ...
            <div>
              <div className="flex items-center gap-3 mt-6">
                <a href="">
                  <FaInstagram className="text-3xl   hover:text-primary hover:scale-200"  />
                </a>
                <a href="#">
                  <FaFacebook className="text-3xl  hover:text-primary hover:scale-200" />
                </a>
                <a href="#">
                  <FaLinkedin className="text-3xl  hover:text-primary hover:scale-200" />
                </a>
              </div>
              <div className="mt-6">
